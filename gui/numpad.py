...
class Numpad(QWidget):
        ...
        for i in range(0, len(self.buttons), 3):
            ...
            for j in range(3):
                if i + j < len(self.buttons):
                    ...
                    button.setFocusPolicy(Qt.FocusPolicy.NoFocus)  # Ensure buttons do not take focus
    ...
    def add_input(self, text):
        ...
        Returns:
            None
        """
        print(f"Button pressed: {text}")  # TODO: Remove this troubleshooting print statement
    ...
    def clear_input(self, _):
        ...
        Returns:
            None
        """
        print("Clear button pressed")  # TODO: Remove this troubleshooting print statement
    ...
    def backspace_input(self, _):
        ...
        Returns:
            None
        """
        print("Backspace button pressed")  # TODO: Remove this troubleshooting print statement
